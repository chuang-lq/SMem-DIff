...
class DeblurDataset(Dataset):
    ...
    def __init__(self, path, frames, ds_type, crop_size=(256, 256), data_format='RGB',
...
class Dataloader:
    def __init__(self, para, device_id, ds_type='train'):
        ...
        dataset = DeblurDataset(path, para.frames, ds_type, para.patch_size, para.data_format, para.centralize, para.normalize)
