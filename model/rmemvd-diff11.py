...
class Model(nn.Module):
    ...
    def forward(self, inputs, gts=None, noise=None, profile_flag=False):
        ...
        for i in range(t - 1, -1, -1):
            ...
            key_curr, shrinkage, selection, encoder_outs, diff_prior = self.memory.encode_key(down_feat, prior_zs[i], encoder_outs=encoder_outs, decoder_outs=decoder_outs)
...
class Memory(nn.Module):
    ...
    def encode_key(self, frame, diff_prior, encoder_outs=None, decoder_outs=None, need_sk=True, need_ek=True):
        encoder_outs, diff_prior = self.key_encoder(frame, diff_prior, encoder_outs=encoder_outs, decoder_outs=decoder_outs)
